<template>
    <main>
        <!-- Using the no-ssr component to match with configured plugin with ssr: false -->
        <no-ssr>
        ...
        <b-row no-gutters class="mb-3">
            <b-col class="bg-dark">
                <b-navbar toggleable="md" type="dark" variant="dark">
                    ...
                    <b-navbar-brand href="/">NuxtJS App</b-navbar-brand>
        ...
        <b-container fluid>
            <!-- nuxt component render tag, this is where our pages end up -->
            <nuxt />
        </b-container>
    </main>
</template>
